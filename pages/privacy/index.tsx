    ...
    <>
      ...
      <main className={styles.main}>
        <div className={styles.privacy}>
          ...
          <h2>個人情報の利用目的</h2>
          <p>当サイトでは、お問い合わせ時にメールアドレス等の個人情報をいただく場合があります。取得した個人情報は、必要な連絡のみに利用し、これらの目的以外では利用いたしません。</p>

          <h2>Cookieの使用</h2>
          <p>当サイトでは、アクセス解析のためにCookieを使用します。Cookieによりブラウザを識別していますが、特定の個人の識別はできない状態で匿名性が保たれています。Cookieの使用を望まない場合、ブラウザからCookieを無効に設定できます。</p>
