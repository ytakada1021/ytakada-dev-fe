...
const About: NextPage = () => {
  return (
    <div>
      <h1 className={styles.technology}>技術スタック</h1>
      ...
      <table border={1}>
        ...
        <tbody>
          <tr>
            ...
            <td><u>バックエンド</u><br />PHP (Laravel), Java (Spring Framework), Python (FastAPI)</td>
          </tr>
          <tr>
      ...
      <h1 className={styles.links}>関連リンク</h1>
      <ul>
        <li>
      ...
      <h1 className={styles.contact}>お問い合わせ</h1>
